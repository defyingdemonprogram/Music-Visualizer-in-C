...
Resource resources[] = {
    ...
    { .file_path = "./resources/shaders/circle.fs" },
...
int main(int argc, char **argv) {
    ...
    if (strcmp(subcommand, "build") == 0) {
        ...
        Svg svgs[] = {
            { .in_path = "./resources/logo/logo.svg",        .out_path = "./resources/logo/logo-256.ico",  .resize = 256 },
            { .in_path = "./resources/logo/logo.svg",        .out_path = "./resources/logo/logo-256.png",  .resize = 256 },
            { .in_path = "./resources/icons/fullscreen.svg", .out_path = "./resources/icons/fullscreen.png" },
            { .in_path = "./resources/icons/volume.svg",     .out_path = "./resources/icons/volume.png"     },
            { .in_path = "./resources/icons/play.svg",       .out_path = "./resources/icons/play.png"       },
            { .in_path = "./resources/icons/render.svg",     .out_path = "./resources/icons/render.png"     },
            { .in_path = "./resources/icons/microphone.svg", .out_path = "./resources/icons/microphone.png" },
        };
